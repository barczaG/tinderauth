      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 44:
            ...
            urlRegex = /\/v2\.1\/dialog\/oauth\/(confirm|read)\?dpr=[0-9]{1}/;
          ...
          case 51:
            ...
            _tokenResponse$0$resp = tokenResponse[0].response.match(/#access_token=(.+)&/);
            _tokenResponse$0$resp2 = (0, _slicedToArray3.default)(_tokenResponse$0$resp, 2);
            token = _tokenResponse$0$resp2[1];
            _context.next = 57;
